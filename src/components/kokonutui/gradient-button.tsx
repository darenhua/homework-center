...
export default function GradientButton({
    ...
    return (
        <Button
            variant="ghost"
            className={cn(
                "group relative h-10 px-4 rounded-lg overflow-hidden transition-all duration-500",
                className
            )}
            {...props}
        >
            ...
            <div className="relative flex items-center justify-center gap-2">
                <span
                    className={cn(
                        "font-light bg-linear-to-b bg-clip-text text-transparent tracking-tighter",
                        colors.light.text,
                        colors.dark.text,
